...
for object_name in 'with a rainbow' 'in a flood' 'in the forest'  'at night' 'in a snow' 'in a sunset'
...
EDIT_PROMPT="a <football-toy> on a <bench-toy> in a park ${object_name}"
