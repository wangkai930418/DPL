...
FILE_NAME="book_cup_telephone"
PROMPT="a <book-toy> a <cup-toy> and a <telephone-toy>"

INDICES='2 4 7'
PLACEHOLDER1='<book-toy>'
PLACEHOLDER2='<cup-toy>'
PLACEHOLDER3='<telephone-toy>'
INIT_TOKEN1='book'
INIT_TOKEN2='cup'
INIT_TOKEN3='telephone'
...
CUDA_VISIBLE_DEVICES=3 python _null_attend_textinv.py \
