...
def arguments():
    ...
    parser.add_argument('--input_image', type=str, default='images/catdog.jpg')
    parser.add_argument('--results_folder', type=str, default='output/catdog')
    parser.add_argument('--results_folder_edit', type=str, default='output/catdog_edit')
    ...
    parser.add_argument('--edit_prompt_str', type=str, default='a <cat-toy> and a <dog-toy>')

    ### NOTE: guidance_scale  
    parser.add_argument('--negative_guidance_scale', default=7.5, type=float)
    parser.add_argument('--postfix', type=str, default='1.0_0.05_0.005_25.0_50.0_25.0_0.3_0.7_0.9_0')
    ...
    parser.add_argument('--original_words', nargs='+', type=str, default=['<dog-toy>'])
