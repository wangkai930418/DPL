...
class StableDiffusion_EditPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        negative_prompt_embeds, edit_prompt_embeds = self._encode_prompt(
            edit_prompt, ### NOTE: prompt before
            device,
            num_images_per_prompt,
            True,  # NOTE: do_classifier_free_guidance,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if do_classifier_free_guidance:
                    prompt_embeds = torch.cat([negative_prompt_embeds.cuda(), 
                                            negative_prompt_embeds.cuda(), 
