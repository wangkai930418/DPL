        ...
        with self.progress_bar(total=num_inference_steps ) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                with torch.enable_grad():
                    ...
                    # target_loss = np.exp(-float(50-i)/26.7)*0.3
                    # target_loss = np.exp(-float(50-i)/46.7)*0.3
                    target_loss = 0.1*0.2
                    ...
                    # predict the noise residual
                        ...
                        loss_max = self._compute_loss(max_attention_per_index)
                        cosine_loss = self._compute_cosine(attention_maps, indices_to_alter)
                        loss=loss_max + cosine_loss*0.2
